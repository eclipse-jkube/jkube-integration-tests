...
@Tag(OPEN_SHIFT)
class JettyOcWatchCopyITCase extends JettyK8sWatch {
  ...
  @Test
  @DisplayName("oc:watch, with mode=copy, SHOULD hot deploy the application")
  @ResourceLock(value = CLUSTER_RESOURCE_INTENSIVE, mode = READ_WRITE)
  void ocWatchCopy() throws Exception {
