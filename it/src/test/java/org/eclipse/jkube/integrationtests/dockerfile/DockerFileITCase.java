...
@Tag(KUBERNETES)
class DockerFileITCase implements JKubeCase, MavenCase {

  private static final String PROJECT_DOCKER_FILE = "projects-to-be-tested/maven/dockerfile/docker-file";
