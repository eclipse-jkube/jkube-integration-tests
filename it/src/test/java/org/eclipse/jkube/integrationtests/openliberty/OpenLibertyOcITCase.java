...
class OpenLibertyOcITCase extends OpenLiberty {
  ...
  void ocResource() throws Exception {
    ...
    assertThat(new File(metaInfDirectory, "jkube/openshift/openliberty-rest-deploymentconfig.yml"), yaml(not(anEmptyMap())));
    assertThat(new File(metaInfDirectory, "jkube/openshift/openliberty-rest-route.yml"), yaml(not(anEmptyMap())));
    assertThat(new File(metaInfDirectory, "jkube/openshift/openliberty-rest-service.yml"), yaml(not(anEmptyMap())));
  }
